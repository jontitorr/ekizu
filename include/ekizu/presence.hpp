 ...
 *
 * This struct represents a button that can be shown in the Rich Presence of an
 * activity. It contains the label and the URL associated with the button.
 *
 * @see
 ...
 *
 * This struct represents an emoji that can be used as a custom status in the
 * activity object. It contains the name, ID, and whether the emoji is animated
 * or not.
 *
 * @see
 ...
 *
 * For more information, refer to the [Discord API
 * documentation](https://discord.com/developers/docs/topics/gateway-events#presence).
 */
struct Presence {
