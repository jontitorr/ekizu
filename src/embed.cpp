...
Embed &Embed::add_field(const EmbedField &field)
{
	if (!fields) {
		fields.emplace();
	}
...
Embed &Embed::add_fields(const std::vector<EmbedField> &fields_)
{
	if (!fields) {
		fields.emplace();
	}
...
Embed &Embed::set_author(const EmbedAuthor &author_)
{
	author = author_;
	return *this;
}

Embed &Embed::set_color(uint16_t color_)
{
	color = color_;
	return *this;
}

Embed &Embed::set_description(const std::string &description_)
{
	description = description_;
	return *this;
}

Embed &Embed::set_footer(const EmbedFooter &footer_)
{
	footer = footer_;
	return *this;
}

Embed &Embed::set_image(const EmbedImage &image_)
{
	image = image_;
	return *this;
}

Embed &Embed::set_provider(const EmbedProvider &provider_)
{
	provider = provider_;
	return *this;
}

Embed &Embed::set_thumbnail(const EmbedThumbnail &thumbnail_)
{
	thumbnail = thumbnail_;
	return *this;
}

Embed &Embed::set_title(const std::string &title_)
{
	title = title_;
	return *this;
}

Embed &Embed::set_url(const std::string &url_)
{
	url = url_;
	return *this;
}

Embed &Embed::set_video(const EmbedVideo &video_)
{
	video = video_;
	return *this;
}

Embed &Embed::set_fields(const std::vector<EmbedField> &fields_)
{
	fields = fields_;
	return *this;
}
